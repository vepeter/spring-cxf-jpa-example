...
//        expectedEmployee1.setBirthDate(new LocalDate(1998, 11, 1));
        assertEquals(expectedEmployee1, employees.get(0));
...
//        expectedEmployee2.setBirthDate(new LocalDate(1998, 11, 2));
        assertEquals(expectedEmployee2, employees.get(1));
...
//        expectedEmployee3.setBirthDate(new LocalDate(1998, 11, 3));
        assertEquals(expectedEmployee1.getDepartment(), employees.get(0).getDepartment());
        assertEquals(expectedEmployee3, employees.get(2));
    }
